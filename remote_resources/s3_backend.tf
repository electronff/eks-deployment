...
# S3 BUCKET
# //////////////////////////////
resource "aws_s3_bucket" "red31-tfremotestate" {
...
resource "aws_s3_bucket_public_access_block" "red31-tfremotestate" {
  bucket = aws_s3_bucket.red31-tfremotestate.id
